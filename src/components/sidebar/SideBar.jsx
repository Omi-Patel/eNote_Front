  ...
  return (
    <div className="  bg-gradient-to-t from-gray-500 to-[#F6E0BE] h-screen border-r ">
      ...
      <div className="flex justify-center">
        <img
          className=" w-52 mt-10 rounded-xl"
          src="https://media.istockphoto.com/id/1412637153/photo/magic-book-with-open-pages-and-abstract-lights-shining-in-darkness-literature-and-fairytale.webp?b=1&s=170667a&w=0&k=20&c=Ppfi8KUg5lN6X9uhktpl0MwHzUHl_tcb9F-WFjNxnHo="
          alt=""
        />
      </div>
